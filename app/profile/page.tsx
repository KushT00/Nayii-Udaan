...
const Dashboard = () => {
  const { userName, userId, userLabels } = useUser();
  ...
  return (
    <div className="flex flex-1">
      <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-4 flex-1 w-full h-full">
        ...
        <p className="text-gray-400">User ID: <span className="text-gray-200">{userId}</span></p>
        <p className="text-gray-400">Labels: <span className="text-gray-200">{userLabels.join(", ") || "None"}</span></p>
